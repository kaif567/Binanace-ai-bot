...
def run():
    ...
    # Forward fill funding rate to klines
    ...
    # Feature Engineering (Strictly Shifted)
    # X Features (What we know AT the close of the previous candle)
    ...
    def evaluate(train, test, name):
        ...
        if prec >= 55.0 and ci_lower > 50.0:
